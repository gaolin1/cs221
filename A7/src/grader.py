...
class TestCase_A7(GradedTestCase):
  ...
  def check(self, part, name, numForms, predictionFunc):
    ...
    if len(predForms) < numForms:
      self.fail("Wanted %d formulas, but got %d formulas:" % (numForms, len(predForms)))
