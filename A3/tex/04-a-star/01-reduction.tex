...
\expect{An implementation of the \texttt{NewSearchProblem} class in the \texttt{aStarReduction(problem, heuristic)} function. As in prior problems, you need to implement \texttt{startState()}, \texttt{isEnd(state)}, and \texttt{successorsAndCosts(state)}.}
