...
If you are using [Conda](https://anaconda.org/anaconda/conda), please walk through the
[Anaconda Setup for XCS Courses](https://github.com/scpd-proed/General_Handouts/blob/master/Anaconda_Setup.pdf) to familiarize yourself with the coding environment.
...
1. Run the installation script:
    ...
    ```
    This will:
    - Create or update the Conda environment specified in `environment.yml`
...
For more detailed setup instructions, please refer to [the environment setup guide](docs/env_setup.md).
...
python train.py --agent function-approximation

# Constrained Q-Learning
python train.py --agent constrained
```
...
python mountaincar.py --agent value-iteration

# Agent trained with Tabular Q-Learning
python mountaincar.py --agent Tabular

# Agent trained with Function Approximation Q-Learning
python mountaincar.py --agent function-approximation

# Agent trained with Constrained Q-Learning
python mountaincar.py --agent constrained
```
